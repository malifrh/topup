    ...
    function callbackNotif_post()
    {
        ...
        if ($result) {
            ...
            if ($data['data']['transaction_status'] == 'success') {
                $status_transaksiVoucher = 'Transaksi Berhasil';
            ...
            Terimakasih';
                    ...
                    $json_resposeWA = json_encode($responses);
                ...
                $updateTransaksi2 = array(
                    'status_transaksi' => $status_transaksiVoucher,
                    'update_date'      => date('Y-m-d H:i:s')
                );

                $this->db->where('id_order', $result->order_id);
                $this->db->update('t_transaksi', $updateTransaksi2);
            }
