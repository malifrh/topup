                ...
                <div class="modal-body">
                    <form method="post" id="formbayar" action="#">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <td width="20%" class="font-weight-bold">Pembayaran</td>
                                    <td width="1%">:</td>
                                    <td width="29%"><span id="pembayaran3"></span></td>
                ...
                <div class="modal-body">
                    <form method="post" id="formbayar" action="#">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <td width="20%" class="font-weight-bold">Kode Pembayaran</td>
                                    <td width="1%">:</td>
                                    <td width="29%"><span id="kode_pay"></span></td>
                        ...
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <td width="20%" class="font-weight-bold">Pembayaran</td>
                                    <td width="1%">:</td>
                                    <td width="29%"><span id="pembayaran2s"></span></td>
